        ...
        3556: (e, t) => {
            ...
            t.default = class AnchorLinks {
                ...
                followMenuAnchor(e, t) {
                    ...
                    if (!r.length) return;
                    r.hasClass("elementor-menu-anchor") || (l = this.calculateRootMargin(r));
                    const h = {
                        root: null,
                        rootMargin: l,
                        threshold: this.buildThreshold(r)
                    };
                    this.createObserver(i, o, e, h).observe(r[0])
                }
                calculateRootMargin(e) {
                    const t = jQuery(window).height(),
                        n = e.outerHeight();
                    let o;
                    if (n > t) o = 0;
                    else {
                ...
                createObserver(e, t, n, o) {
                    return new IntersectionObserver((o => {
                        o.forEach((o => {
                            o.isIntersecting ? (e.addClass(t), n.attr("aria-current", "location")) : (e.removeClass(t), n.attr("aria-current", ""))
                        }))
                    }), o)
                }
            }
